...
describe("Transpatent patern", function () {
  ...
  beforeEach(async function () {
    ...
    const Tr4 = await ethers.getContractFactory("TransparentV4")
  ...
  it("checking value", async function () {
    ...
    expect(await tr4.value()).to.equal(BigNumber.from('42'))
    ...
    expect(await tr4.value()).to.equal(BigNumber.from('43'))
